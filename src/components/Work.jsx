...
function Work() {
  ...
  return (
    <div className="w-full relative">
      <div className="max-w-scren-2xl mx-auto px-5 sm:px-10">
        <div className="featured flex gap-3">
          ...
          <h3 className="capitalize">featured products</h3>
        </div>
              ...
              <div key={index} className="elem w-full sm:w-[48%] mt-10">
                <div className="video w-full h-[104vw] sm:h-[50vw] relative overflow-hidden">
                  <motion.img
                    ...
                    data-scroll
                    data-scroll-speed="-.5"
                    className="hidden sm:block sm:absolute sm:z-[2] sm:top-0 sm:left-0 w-full h-full object-cover"
                    src={item.image}
                    alt=""
                  />
                  <video
